    ...
    <div className="footer-grid" style={{
      ...
      <div>
        <Link to="/" style={{ lineHeight: 0, display: "inline-block", marginBottom: "20px" }}>
          <img src="/logo.png" alt="Tender Living Residence" style={{ height: "clamp(40px, 8vw, 64px)", objectFit: "contain", display: "block", filter: "invert(1) sepia(1) hue-rotate(-30deg) saturate(2.5) brightness(1.25)" }} />
        </Link>
      ...
      <nav>
        ...
        <Link to="/services/home-based-care/home-based-respite" style={footLink}>Respite Care</Link>
        <Link to="/services/home-based-care/complex-care"       style={{ ...footLink, marginBottom: "18px" }}>Complex Care</Link>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <div>
              ...
              <a href="mailto:info@tlrs.co.uk" style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#f4a5c6", textDecoration: "none" }}>info@tlrs.co.uk</a>
            </div>
            <div>
